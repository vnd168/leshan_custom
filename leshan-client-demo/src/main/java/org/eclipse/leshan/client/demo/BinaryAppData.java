...
public class BinaryAppData extends BaseInstanceEnabler implements Destroyable {
    ...
    public BinaryAppData() {
    }

    public BinaryAppData(ScheduledExecutorService executorService, Integer id) {
        try {
