...
public class LeshanClientDemo {
    ...
    private static final int OBJECT_ID_BINARY_APP_DATA = 19;
    private static final int OBJECT_ID_LWM2M_TEST_OBJECT = 3304;
    ...
    public static LeshanClient createClient(LeshanClientDemoCLI cli, LwM2mModelRepository repository) throws Exception {
        ...
        initializer.setInstancesForObject(OBJECT_ID_BINARY_APP_DATA, new BinaryAppData());
